...
public class KnotxConsumersIntegrationTest {

  @ClasspathResourcesMockServer
  private WireMockServer mockService;

  @Test
  @DisplayName("Should return fragment properly processed by consumer")
  @KnotxApplyConfiguration({"conf/application.conf",
      "scenarios/knotx-consumers-integration/mocks.conf",
      "scenarios/knotx-consumers-integration/tasks.conf"})
